...
const routes: Routes = [
  ...
  { path: 'tester/:proyectoId/incidentes',component: IncidentesPComponent,canActivate:[UserLoggedGuard, TesterLoggedGuard]},
  { path: 'tester/:proyectoId/tareas',component: VerTareasComponent,canActivate:[UserLoggedGuard, TesterLoggedGuard]},
  { path: 'desarrollador/:proyectoId/incidentes',component: IncidentesPComponent,canActivate:[UserLoggedGuard, DesarrolladorLoggedGuard]},
  { path: 'desarrollador/:proyectoId/tareas',component: VerTareasComponent,canActivate:[UserLoggedGuard, DesarrolladorLoggedGuard]},
